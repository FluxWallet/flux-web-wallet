...
contract FluxWallet is ERC165, IERC1271, SimpleWallet, DeadManSwitch, SocialRecover, SessionManagement {
  /************************************************
   *  STORAGE
   ***********************************************/
  ...
  constructor(IEntryPoint anEntryPoint, address anOwner, uint _root) SimpleWallet(anEntryPoint, anOwner) {
    root = _root;
  ...
  function sendTransaction(address payable dest, uint256 amount) external onlyOwner {
